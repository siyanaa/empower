...
class SitesettingSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('site_settings')->insert([
            'office_name' => 'Empower HR Solutions',
            'office_address' => json_encode(['Kathmandu, Nepal']), 
            'office_contact' => json_encode(['9779851071224', '+971 56 834 8300']),
            'office_email' => json_encode(['info@empower.com', 'empowersolutions@gmail.com']),
            ...
            'facebook_link' => 'https://www.facebook.com/empowersolution',
            'instagram_link' => 'https://www.instagram.com/empowersolution/',
            'snapchat_link' => 'https://www.snapchat.com/empowersolution/',
            'linkedin_link' => 'https://www.linkedin.com/in/empowersolution/',
