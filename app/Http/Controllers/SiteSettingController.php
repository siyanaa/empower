    ...
    public function store(Request $request)
{
    $this->validate($request, [
        ...
        'main_logo' => 'required|image|mimes:jpg,png,jpeg,gif,svg,webp|max:1536',
        'side_logo' => 'nullable|image|mimes:jpg,png,jpeg,gif,svg,webp|max:1536',
   ...
   public function update(Request $request, $id)
{
    $request->validate([
        ...
        'office_email.*' => 'required|string',
        'whatsapp_number' => 'required|string',
        'main_logo' => 'nullable|image|mimes:jpg,png,jpeg,gif,svg,webp|max:1536',
        'side_logo' => 'nullable|image|mimes:jpg,png,jpeg,gif,svg,webp|max:1536',
        'company_registered_date' => 'required|date_format:Y-m-d',
        'facebook_link' => 'nullable|url',
        'instagram_link' => 'nullable|url',
